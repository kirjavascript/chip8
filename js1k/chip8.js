...
J=[...'x123qweasdzc4rfv'];
T=[...Array(4016)].fill(0);
K=[240,144,144,144,240,32,96,32,32,112,240,16,240,128,240,240,16,240,16,240,144,144,240,16,16,240,128,240,16,240,240,128,240,144,240,240,16,32,64,64,240,144,240,144,240,240,144,240,16,240,240,144,240,144,144,224,144,224,144,224,240,128,128,128,240,224,144,144,144,224,240,128,240,128,240,240,128,240,128,128].concat(T)
V=T.slice(0,16);
M=T.slice(0,2048);
            ...
            switch(O=K[H]<< 8|K[H+1],x=(O&3840)>>8,y=(O&240)>>4,z=O&15,R=O&255,Q=O&4095,H+=2,O&61440){
                ...
                case 53248:
                    ...
                    K.slice(I,z+I).map((a,b)=>{
                        for(j=0;8>j;j++) {
                            (a&128)>0&&(x0=V[x]+j,y0=V[y]+b,loc=(0>x0?x0+64:x0%64)+64*(0>y0?y0+32:y0%32),M[loc]^=1,M[loc]||(V[15]=1)),a<<=1;
                        }
                    });
                    break;
                case 57344:
