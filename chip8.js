...
J=[...'x123qweasdzc4rfv'];
T=Array(4016).fill(0);
K=[15,9,9,9,15,2,6,2,2,7,15,1,15,8,15,15,1,15,1,15,9,9,15,1,1,15,8,15,1,15,15,8,15,9,15,15,1,2,4,4,15,9,15,9,15,15,9,15,1,15,15,9,15,9,9,14,9,14,9,14,15,8,8,8,15,14,9,9,9,14,15,8,15,8,15,15,8,15,8,8,0].map(d=>d*16).concat(T);
V=T.slice(0,16);
M=T.slice(0,2048);
